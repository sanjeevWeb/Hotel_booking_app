...
], upload.array("imageFiles", 6), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.put("/:hotelId", auth_middleware_1.default, upload.array("imageFiles"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
